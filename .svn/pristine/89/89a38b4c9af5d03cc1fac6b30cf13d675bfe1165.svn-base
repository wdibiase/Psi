...
/****** Object:  StoredProcedure [dbo].[db-role-delete_user_from_role]    Script Date: 2012.07.12. 13:52:21 ******/
SET ANSI_NULLS ON
GO
...
CREATE procedure [dbo].[db-role-delete_user_from_role]  (
...
BEGIN
	...
	begin
		delete from [dbo].[db-user_role] where userid=@userid and roleid=@roleid
