...
<asp:Content runat="server" ContentPlaceHolderID="pagina">
    ...
    <div class="col-md-12" id="MenuOpciones" role="tabpanel">
        ...
        <asp:Panel runat="server" id="panelDetalle" Visible="true">
            <asp:Button ID="btnEvaluar" runat="server" CssClass="btn-toolbar" Text="Evaluar" OnClick="btnEvaluar_Click" CausesValidation="false" />
        ...
        <asp:Panel runat="server" ID="panelHC" Visible="false">
